...
export const ProjectModal = async ({ project: projectId }: Props) => {
  ...
  return (
    <ModalPortal visible={true} query="project">
      <div className="modal-scroll-wrapper max-h-[98%] w-[98%] md:w-2/3">
        <StopPropagation className="bg-background relative flex flex-col gap-4 rounded-2xl p-4 text-white">
          ...
          <div className="flex flex-col items-center gap-4 select-none">
            ...
            <Image src={image} alt="Project" width={300} height={300} />
